...
## 2026-08-19 (daily)
- gold ✓ 142.700 (SJC 139.700/142.700 qua crawl_gold.py, giavang.org, giảm ~0,9% so 08-16 141.000/144.000, dưới ngưỡng flag 5%/ngày; DOJI không lấy được — update.giavang.doji.vn tiếp tục không ổn định, để rỗng theo thiết kế, không self-heal)  fx ✓ 26.370 (VCB API: mua tiền mặt 25.960, mua CK 25.990, bán 26.370; SBV central rỗng; tăng ~0,15% so 08-16)  fuel – kỳ hiện tại 2026-08-13 vẫn còn hiệu lực, không có kỳ mới  gas – ngoài cửa sổ check 1–4, tháng 08/2026 đã có sẵn  rates skip  electricity skip
...
## 2026-08-19 (gap-catchup)
- gold ✓ 08-17 141.800/144.800 (webgia.com/gia-vang/sjc/DD-MM-YYYY.html) — ok=1 skip=1: 08-18 KHÔNG có bảng SJC trên webgia (đã kiểm cả web.archive.org, không có snapshot) → để trống theo nguyên tắc không bịa số, không phải lỗi parser.
- fx ✓ 08-17 26.400, 08-18 26.380 (VCB API, cả 2 ok, SBV central rỗng theo quy ước backfill).
- rates ✓ 2026-W34 (24hmoney, chạy live 08-19 vẫn cùng tuần ISO với thứ Hai đã lỡ 08-17 — không phải bịa số quá khứ, giống case W33 08-11 trước đây): 20/20 ngân hàng, 99/100 dòng (thiếu Sacombank kỳ 24 tháng — nguồn không niêm yết), đối chiếu tay so W33 không ngân hàng nào đổi >2 điểm%/tuần.
- electricity ✓ check: QĐ 1279/QĐ-BCT (10/05/2025) vẫn hiện hành, không có biểu giá mới; NĐ 278/2026/NĐ-CP chỉ đổi quy trình điều chỉnh giá, không phải biểu giá bậc thang mới.
- flags: (không có flag mới; validate.py --full: errors=0, chỉ còn 2 flag lịch sử cũ không liên quan — gold 2026-02-03, 2026-06-12)
- ghi chú: gap catch-up cho khoảng trống thực (không phải cuối tuần) 2026-08-17 (thứ Hai) và 2026-08-18 (thứ Ba) — routine daily không chạy 2 ngày này nên bỏ lỡ cả kỳ rates/electricity thứ Hai. Phát hiện qua yêu cầu owner rà lại dữ liệu thiếu. Không self-heal, không domain thiếu. site-builder OK 5/5 module. Ghi nhận kỹ thuật (không sửa): `scripts/backfill_fx.py` và `scripts/crawl_rates.py` có `UnicodeEncodeError` cosmetic ở dòng print cuối trên console Windows cp1252 (ký tự "→"/"✓"), không ảnh hưởng dữ liệu đã ghi — cần `PYTHONIOENCODING=utf-8` hoặc sửa `scripts/common.py::emit` khi có thời gian.
...
- rates/electricity/gas: không backfill — không thuộc lịch thu thập (rates/electricity chỉ thứ Hai, gas chỉ đầu tháng), không có gì để lấp cho 08-13/08-14.
- flags: (không có flag mới; validate.py: errors=0 flags=0)
- ghi chú: catch-up cho khoảng trống daily 08-13/08-14 (giữa lần chạy 08-12 và 08-15), theo yêu cầu owner. Không phải phần daily thường, không tự chạy tự động. Chi tiết nguồn ở `data/provenance.md` mục "Gap catch-up 2026-08-15". site-builder OK 5/5 module.

## 2026-08-15 (daily)
- gold ✓ 144.000 (SJC 141.000/144.000 qua crawl_gold.py, giavang.org, tăng ~0,35% so 08-12 140.500/143.500, dưới ngưỡng flag 5%/ngày; DOJI không lấy được — update.giavang.doji.vn tiếp tục không ổn định, để rỗng theo thiết kế, không self-heal)  fx ✓ 26.330 (VCB API: mua tiền mặt 25.920, mua CK 25.950, bán 26.330; SBV central rỗng; tăng ~0,04% so 08-12)  fuel ✓ kỳ mới hiệu lực 2026-08-13 15h (ron95 22.110 / e5ron92 21.230 / diesel 27.230 / dầu hỏa 26.170 — Petrolimex daily vẫn ảnh nên parse tay từ bài thông cáo Petrolimex, dưới ngưỡng flag 20%)  gas – ngoài cửa sổ check 1-4, tháng 08/2026 đã có sẵn  rates skip  electricity skip
- flags: (không có flag mới; validate.py: errors=0 flags=0)
- ghi chú: hôm nay thứ Bảy nên rates & electricity skip theo lịch. **Gián đoạn 2 ngày** — lần chạy daily gần nhất trước đó là 2026-08-12 (#39); các ngày 08-13, 08-14 không có run daily riêng, nhưng kỳ điều hành xăng mới (hiệu lực 08-13) vẫn bắt kịp bình thường vì fuel lưu theo effective_date/kỳ, không tính backfill. Không self-heal, không domain thiếu. site-builder OK 5/5 module.
...
- flags: (không có flag mới; validate.py: errors=0 flags=0)
- ghi chú: hôm nay thứ Ba nên rates & electricity skip theo lịch daily thường. **Gián đoạn 4 ngày** — lần chạy daily gần nhất trước đó là 2026-08-06 (#36); các ngày 08-07 đến 08-10 KHÔNG có run (kể cả 08-10 là thứ Hai). Kỳ điều hành xăng mới (hiệu lực 08-06) được bắt kịp bình thường vì fuel lưu theo effective_date/kỳ, không tính là backfill. Cần rà lại lịch chạy routine để tránh gián đoạn lặp lại.
  - **Catch-up one-off riêng (không phải phần daily), theo yêu cầu owner:** `backfill_gold.py`/`backfill_fx.py --from 2026-08-07 --to 2026-08-10` → gold ok=3 skip=1 (09 CN không có bảng chốt) fail=0; fx 4/4 ngày, 0 fail; DOJI/SBV vẫn trống theo thiết kế backfill. Rates tuần **2026-W33** (lẽ ra thu thứ Hai 08-10) thu muộn ngày 08-11 bằng crawl LIVE bình thường — hợp lệ vì 08-11 vẫn nằm trong cùng tuần ISO W33, không phải bịa số quá khứ; đủ 20/20 NH, kỳ hạn 1/3/6/12 đủ, 24 tháng có ở 19/20 NH (nguồn 24hmoney tuần này có thêm cột 24 tháng, khác ghi chú cũ trong CLAUDE.md — không phải lỗi, không sửa). Electricity check catch-up: **không đổi**, QĐ 1279/QĐ-BCT (09/05/2025) vẫn hiện hành, không có biểu giá mới trong khoảng bị lỡ; NĐ 278/2026/NĐ-CP chỉ đổi thủ tục điều chỉnh giá bình quân, không phải biểu giá bậc thang mới nên không thêm vào `electricity.json`. Chi tiết nguồn ở `data/provenance.md` mục "Gap catch-up 2026-08-11". Không self-heal, không domain thiếu. site-builder OK 5/5 module.
