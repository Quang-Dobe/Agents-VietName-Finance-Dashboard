...
| fuel | — | thử vietnambiz (bài "đồng loạt"), petrolimex (ảnh), webgia (JS) | **Chưa backfill được — nguồn quá nhiễu.** vietnambiz chỉ có ~15 bài "đồng loạt"/năm (thiếu nhiều kỳ), RON95 vắng ở phần lớn bài, và lẫn giá tham chiếu nước ngoài (Thái/Lào/TQ) khiến parser lấy sai (E5 28k, diesel 27k). Không publish số sai. `backfill_fuel.py` giữ lại làm điểm khởi đầu; giữ seed, daily dựng tới. |
